          ...
          <div className="jumbotron monJumbottron2 row">
              ...
              <div className="col-6">
                  ...
                  <p className="justify">
                      ...
                      Dans chacun de ces thèmes, vous avez cinq questions avec quatre possibilités de réponse.
                      Attention ! Il peut y avoir plusieurs bonnes réponses pour une question !
                      À la fin de votre quiz, un score vous sera attribué. Aucun point ne vous sera retiré pour une mauvaise réponse.
                  </p>
                  <p className="justify">
